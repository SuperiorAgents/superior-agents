...
def assisted_flow(
	...
	agent.db.insert_chat_history(session_id=session_id, chat_history=agent.chat_history)
	...
	agent.db.insert_strategy_and_result(
		...
		strategy_result=StrategyInsertData(
			...
			parameters={
				...
				"trading_instruments": trading_instruments,
				"metric_name": metric_name,
				"start_metric_state": str(start_metric_state),
				"end_metric_state": str(end_metric_state),
